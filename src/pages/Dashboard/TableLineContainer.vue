<template>
  <tr class="payment-row">
    <td>
      <div class="payment">{{ getStudentNameById(payment.studentId) }}</div>
    </td>
    <td>
      <div class="payment">
        <list-paragraph-container
          :paragraphText="payment.date"
          :currentTabProp="currentTab"
          @edit-finished="switchToTextFromDate"
        ></list-paragraph-container>
      </div>
    </td>
    <td>
      <div class="payment">
        <list-paragraph-container
          :paragraphText="payment.paymentAmount"
          :currentTabProp="currentTab"
          @edit-finished="switchToTextFromPayment"
        ></list-paragraph-container>
      </div>
    </td>
    <td>
      <i class="tim-icons icon-pencil edit-btn" @click="changeToEdit()"></i>
    </td>
    <td>
      <i
        class="tim-icons icon-trash-simple delete-btn"
        @click="$emit('delete-payment', payment._id)"
      ></i>
    </td>
  </tr>
</template>
